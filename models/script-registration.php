                  ...
                  if ($password == $repeat_password) {
                    ...
                    if(preg_match("/^[^\W][a-zA-Z0-9_]+(\.[a-zA-Z0-9_]+)*\@[a-zA-Z0-9_]+(\.[a-zA-Z0-9_]+)*\.[a-zA-Z]{2,4}$/",$email)){
                      ...
                      <html>
                         <body>
                            <div align="center">
                               <a href="http://127.0.0.1/my-app/ActivistSoft/models/confirm-registration.php?name='.urlencode($name).'&firstname='.urlencode($firstname).'&key='.$key.'">Confirmez votre compte !</a>
                            </div>
                         </body>
                      </html>
                      ';
